...
const ProductsDetailsContent = ({ data }) => {
  ...
  const getProductSlug = productSlug;
  const Platinum = router.asPath.split("/")[2];
  const SKU =
    products && products?.category && products?.category?._id.slice(0, 6);
  const platinumPrinter = products?.platinumprinter;
  const Specifications = products?.platinumspecification;
  const additional_information = products?.platinumdetails;
  const description = products?.platinumdescription;
  const videoLink = products?.platinumattributes[0]?.color[0]?.video;
  ...
  const price =
    products &&
    products?.platinumattributes[updateSizeIndex]?.color[updateColorIndex] &&
    products &&
    products?.platinumattributes[updateSizeIndex]?.color[updateColorIndex]
      ...
      : products &&
        products?.platinumattributes[0] &&
        products?.platinumattributes[0]?.color[0]?.fabric[0]?.price;

  const size =
    products &&
    products.platinumattributes[updateSizeIndex].color[updateColorIndex] !=
      undefined
      ? products.platinumattributes[updateSizeIndex].title
      : products &&
        products.platinumattributes[0] &&
        products.platinumattributes[0].title;
  ...
  const color =
    ...
    products.platinumattributes[updateSizeIndex].color[updateColorIndex] !=
      ...
      : products &&
        products.platinumattributes[0] &&
        products.platinumattributes[0].color[0].colorCode;

  const fabric =
    products &&
    products.platinumattributes[updateSizeIndex].color[updateColorIndex] &&
    products &&
    products.platinumattributes[updateSizeIndex].color[updateColorIndex].fabric[
      updateFabricIndex
    ] != undefined
      ? products.platinumattributes[updateSizeIndex].color[updateColorIndex]
          .fabric[updateFabricIndex].fabricName
      : products &&
        products.platinumattributes[0] &&
        products.platinumattributes[0].color[0].fabric[0].fabricName;
  ...
  const mrp =
    ...
    products.platinumattributes[updateSizeIndex].color[updateColorIndex].fabric[
      ...
      : products &&
        products.platinumattributes[0] &&
        products.platinumattributes[0].color[0].fabric[0].mrp;

  const image =
    products &&
    products.platinumattributes[updateSizeIndex] &&
    products.platinumattributes[updateSizeIndex] &&
    products &&
    products.platinumattributes[updateSizeIndex] &&
    products.platinumattributes[updateSizeIndex].color[updateColorIndex] &&
    products &&
    products.platinumattributes[updateSizeIndex] &&
    products.platinumattributes[updateSizeIndex].color[updateColorIndex].images[
      updateImageIndex
    ] != undefined
      ? products &&
        products.platinumattributes[updateSizeIndex] &&
      ...
      : products &&
        products.platinumattributes[updateSizeIndex] &&
        products.platinumattributes[updateSizeIndex].color[0].images[0].img;
  ...
  const addToCart = async (e) => {
    ...
    try {
      ...
      window.sessionStorage.setItem("product_type", "platinum");
      window.sessionStorage.setItem("printer_id", platinumPrinter);
    }
  };
        ...
        <div className="products-details-area ptb-100">
          <div className="container-fluid">
            <div className="row align-items-center">
              ...
              >
                {products &&
                products.platinumattributes &&
                products.platinumattributes[updateSizeIndex].color[
                  updateColorIndex
                ] != undefined
                  ? products &&
                    products.platinumattributes &&
                  ...
                  : products &&
                    products.platinumattributes &&
                    products.platinumattributes[0].color[0].images.map(
                      (items, index) => {
                        return (
                          <div
                            className="mb-4"
              ...
              <div className="col-lg-5 col-md-12">
                <div className="products-details-desc">
                  ...
                  <div className="price">
                    <span className="new-price">
                      ...
                      products.platinumattributes[updateSizeIndex].color[
                        ...
                        : products &&
                          products.platinumattributes[0] &&
                          products.platinumattributes[0].color[0].fabric[0]
                            .price}
                    </span>
                  ...
                  <div className="products-review d-flex">
                    ...
                    <div>{products && products.reviews.length} reviews</div>
                  </div>
                  <p>{ReactHtmlParser(description)}</p>

                  <ul className="products-info">
                    <li>
                      <span>SKU:</span> AB254ABC
                    </li>
                    <li>
                  ...
                  <div className="products-size d-flex">
                    ...
                    <ul className="size">
                      {products &&
                        products.platinumattributes &&
                        products.platinumattributes.map((items, index) => {
                          return (
                            <li
                              key={index}
                              onClick={() => {
                  ...
                  <div className="products-color">
                    ...
                    <ul className="colors">
                      {products &&
                        products.platinumattributes[updateSizeIndex] &&
                        products.platinumattributes[updateSizeIndex].color.map(
                          (items, index) => {
                            return (
                              <li
                                style={{
                  ...
                  <div className="products-fabric">
                    ...
                    <div>
                      <Link href={`/product/gold/${productSlug}`}>
                        <Button
                          style={{
                    ...
                    <p className="mt-1">
                      Soft and breathable 100% cotton t-shirt
                    </p>
                  </div>
