...
import metaData from "../public/metadata/terms.json";
        ...
        <div className="container">
          <div className="terms-conditions-content">
            ...
            <p>
              ...
              the use of Spicywhips's Website, located at{" "}
              <a href="https://spicywhips.com/">https://spicywhips.com/</a>.
            </p>
            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Spicywhips if you do not agree
            ...
            <h2>Cookies</h2>
            <p>
              We employ the use of cookies. By accessing Spicywhips, you agreed
              to use cookies in agreement with the Spicywhips's Privacy Policy.
            </p>
            <p>
            ...
            <h2>License</h2>
            <p>
              Unless otherwise stated, Spicywhips and/or its licensors own the
              intellectual property rights for all material on Spicywhips. All
              intellectual property rights are reserved. You may access this
              from Spicywhips for your own personal use subjected to
              restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from Spicywhips</li>
              <li>Sell, rent or sub-license material from Spicywhips</li>
              <li>Reproduce, duplicate or copy material from Spicywhips</li>
              <li>Redistribute content from Spicywhips</li>
            </ul>
            <p>
            ...
            <p>
              ...
              Spicywhips does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of Spicywhips, its agents and/or affiliates.
              ...
              laws, Spicywhips shall not be liable for the Comments or for any
            ...
            <p>
              Spicywhips reserves the right to monitor all Comments and to
            ...
            <p>
              You hereby grant Spicywhips a non-exclusive license to use,
            ...
            <ol>
              ...
              <li>
                ...
                compensates the absence of Spicywhips; and
              </li>
              <li>
            ...
            <p>
              ...
              by sending an e-mail to Spicywhips. Please include your name, your
            ...
            <p>
              No use of Spicywhips's logo or other artwork will be allowed for
